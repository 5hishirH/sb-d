...
exports.deleteAssignmentById = exports.updateAssignmentById = exports.getAssignmentById = exports.getAllAssignments = exports.createAssignment = void 0;
...
exports.createAssignment = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const newAssignment = await assignment_model_1.default.create(req.body);
    res.status(201).json({
        success: true,
