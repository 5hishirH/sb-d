...
const materialContentBaseSchema = zod_1.z.object({
...
const moduleMaterialContentSchema = materialContentBaseSchema.extend({
    materialType: zod_1.z.literal("ModuleMaterial").default("ModuleMaterial"),
});
const finalMaterialContentSchema = materialContentBaseSchema.extend({
...
const moduleSchema = zod_1.z
    ...
    materials: zod_1.z.array(moduleMaterialContentSchema).optional(),
...
exports.getCourseSchema = zod_1.z.object({
    ...
    query: zod_1.z.object({
        content: zod_1.z.enum(["videos", "materials", "quizzes"]).optional(),
    }),
});
